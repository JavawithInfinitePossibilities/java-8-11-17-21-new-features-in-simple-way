...
import com.sid.tutorials.spring.boot3.java.app.datamanipulation.FunctionInterfaceForExmpl;
...
public class AppTest {
    ...
    @Test
    public void testFunctionInterfaceForExmpl() {
        FunctionInterfaceForExmpl functionInterfaceForExmpl = name -> "Hello, " + name + "!";
        System.out.println(functionInterfaceForExmpl.setMyname("Sid"));
        System.out.println(functionInterfaceForExmpl.display());
    }
}
