...
import com.sid.tutorials.spring.boot3.java.app.DTO.dtointerface.IVehicle;
...
public class AppTest {
    ...
    @Test
    @DisplayName("Test Encapsulation with payment")
    public void testEncapsulationPayment() {
    ...
    @Test
    @DisplayName("Test Encapsulation with IVehicle")
    public void testEncapsulationVehicle() {
        try {
